...
// NOTE(x-heep vendoring): the upstream file also defines 'obi_mux_intf', an
// SV-interface-flavored wrapper around this module using the OBI_BUS
// interface. This repo's OBI vendoring deliberately excludes the
// interface-based flavor of the PULP OBI package (see the exclusion of
// src/obi_intf.sv in ../../obi.vendor.hjson) in favor of the struct-based
// req_t/rsp_t style used throughout. 'obi_mux_intf' (and its otherwise
// unused `include "obi/typedef.svh") were trimmed for that reason.
